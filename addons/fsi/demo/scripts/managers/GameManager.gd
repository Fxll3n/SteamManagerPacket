...
const PLAYER_SCENE = preload("res://addons/fsi/demo/scenes/prefabs/player.tscn")

var is_game_started: bool = false

func _ready() -> void:
	NetworkManager.recieved_packet.connect(_on_packet_recieved)
...
func start_game() -> void:
	...
	print("lobby members:\n", NetworkManager.lobby_members)
	var target_scene = "res://addons/fsi/demo/scenes/levels/game.tscn"
